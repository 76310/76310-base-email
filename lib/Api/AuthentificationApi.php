...
class AuthentificationApi
{
    ...
    {
        list($response) = $this->tokenWithHttpInfo($request);
        return $response;
    }
     ...
     */
    public function tokenAsync($request = null)
    {
        return $this->tokenAsyncWithHttpInfo($request)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     */
    protected function tokenRequest($request = null)
    {
